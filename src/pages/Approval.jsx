function Approval() {
  return (
    <div>
      <h1 className="uppercase text-center">Approval Page</h1>
      <p className="py-6">
      ...
      <div className="flex flex-row gap-10 lg:gap-50 xl:gap-100 2xl:gap-150 mt-25 lg:mt-40 2xl:mt-60">
        <div className="w-1/2">
          ...
          <h2 className="uppercase my-3">Dr S.O. Akinoso</h2>
          <p>Supervisor</p>
        </div>
        
        <div className="w-1/2">
          <hr className="md:w-[200px] w-[150px]" />
          <p className="uppercase font-bold my-3">Date</p>
        </div>
      </div>
      ...
      <div className="flex flex-row gap-10 lg:gap-50 xl:gap-100 2xl:gap-150 mt-25 lg:mt-40 2xl:mt-60">
        <div className="w-1/2">
          <hr className="md:w-[200px] w-[150px]" />
          <h2 className="uppercase my-3">Prof. Sunday Adeyemo</h2>
      ...
      <div className="flex flex-row gap-10 lg:gap-50 xl:gap-100 2xl:gap-150 mt-25 lg:mt-40 2xl:mt-60">
        <div className="w-1/2">
          <hr className="md:w-[200px] w-[150px]" />
          <h2 className="capitalize my-3">External Examiner</h2>
        </div>
